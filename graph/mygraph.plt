...
set terminal png
set output "CriticalReport.png"
set title "REPORT FROM LAST 24 HOURS"
set xlabel "Category"
...
plot "mydata.txt" using 1:3 with lines title "All Important Reports" lw 2,"mydata.txt" using 1:3 with points title "1=Emrgncy, 2=Alert, 3=Critical, 4=Error, 5=Warning, 6=Notice" lw 2
