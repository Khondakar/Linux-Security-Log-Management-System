...
set terminal png
set output "CriticalReportWeekly.png"
set title "REPORT FROM LAST 1 WEEK"
set xlabel "Category"
...
# -------------------------------------------------------------------------------------------------------
plot "./graph/weeklydata.txt" using 1:3 with lines title "All Important Reports" lw 2,"./graph/weeklydata.txt" using 1:3 with points title "1=Emrgncy, 2=Alert, 3=Critical, 4=Error, 5=Warning, 6=Notice" lw 2
