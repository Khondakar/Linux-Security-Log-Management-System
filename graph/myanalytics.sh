...
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
echo "1) Count of Emergency issue = $emergencyCount"
echo "2) Count of Alert = $alertCount"
echo "3) Count of Critical issue = $criticalCount"
echo "4) Count of Error = $errorCount"
echo "5) Count of Warning = $warningCount"
echo "6) Count of Notification = $noticeCount"
echo -e "\e[30;48;5;238m                                                                  \e[0m" # Grey Line

# Write all data in file
echo "1 Emergency $emergencyCount" > mydata.txt
echo "2 Alert $alertCount" >> mydata.txt
echo "3 Critical $criticalCount" >> mydata.txt
echo "4 Error $errorCount" >> mydata.txt
echo "5 Warning $warningCount" >> mydata.txt
echo "6 Notice $noticeCount" >> mydata.txt

# Run the gnuplot using the setting of plotting a graphy
gnuplot ./graph/mygraph.plt

# Display the graph saved as PNG file generate with data
eog CriticalReport.png
