...
sudo journalctl --since "1 week ago" | grep "$inputword" > /home/khondakar/workSpace/LMS/Reports/ReportLast7Days.txt

# Display the result column wise with highlighted searching key word
column -t /home/khondakar/workSpace/LMS/Reports/ReportLast7Days.txt | grep --color=always "$inputword" | more
